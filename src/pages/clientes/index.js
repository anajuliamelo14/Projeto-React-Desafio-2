  ...
  return (
    <div className="container">
      ...
      <button
        ...
        id={cliente.id}
        onClick={editar}
        class="btn btn-outline-sucess btn-sm mr-3"
      ...
      <button
        id={cliente.id}
        onClick={excluir} 
       class="btn btn-outline-sucess btn-sm espacar">
             Excluir
      </button>
                  </td>
                </tr>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-2">
                    <label for="telefone" className="form-label">CPF</label>
                  ...
                  <div className="col-sm-3">
                    <label for="cpf" className="form-label">Telefone</label>
              ...
              <div className="modal-footer">
                ...
                <button id="btn-cancelar" className="btn btn-primary btn-sm" data-bs-dismiss="modal">Cancelar</button>
              </div>
            </div>
          </div>
        </div>
